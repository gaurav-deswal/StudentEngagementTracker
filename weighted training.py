...
from utils import get_dataloader,get_dataloader_weighted
...
dataloader = get_dataloader_weighted(batch_size,
                            'csv\\train.csv',
                            os.getcwd(),
                            'csv\\test.csv',
                            os.getcwd())
...
# for idx, i in enumerate(dataloader['train']):
#     print(i[0].shape)
...
with open('train_losses_mod__weighted-11.pkl', 'wb') as f:
    pickle.dump(train_losses, f)

with open('val_losses_mod_weighted-11.pkl', 'wb') as f:
    pickle.dump(val_losses, f)

torch.save(model.state_dict(), 'resTCN_mod_model_weighted-11.pth')
